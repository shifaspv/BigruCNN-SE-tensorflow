...
def get_configuration(learning_phase):
    ...
    if learning_phase == 'generation':     
        parser.add_argument('--noisy_speech_filename', type=str, default='p232_005', help='The input noisy filename') 
...
#        cfg['target_length'] = None 
    ...
    if learning_phase == 'generation':
        ...
        cfg['test_clean_audio_dir'] = os.path.join(cfg['data_dir'], cfg['test_clean_audio_dir'])        
