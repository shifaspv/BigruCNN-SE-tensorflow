...
Since the model can capture the local recurrency pattern of the speech and noise while permforming the enhancement task, in contrast to the traditional recurrency modelling  <a href="https://www.microsoft.com/en-us/research/uploads/prod/2018/02/ZhaoZararTashevLee_ICASSP_2018.pdf">[1]</a>, <a href="https://web.cse.ohio-state.edu/~wang.77/papers/Tan-Wang1.interspeech18.pdf">[2]</a> that models the recurrency independently from the front-end feature extraction, it guarantees better quality enhancement. This is an inital attempt towards building higher models motivated from this startegy.
