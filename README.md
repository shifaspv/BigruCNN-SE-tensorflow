# Bidirectional Recurrent Convolution (BigruCNN) and its application to speech enhanceemnt
...
Since the model can capture the locall recurrency pattern of the speech and noise while permofrming the enhancement task, in contrast to the traditional recurrency modelling  <a href="https://www.microsoft.com/en-us/research/uploads/prod/2018/02/ZhaoZararTashevLee_ICASSP_2018.pdf">[1]</a>, <a href="https://web.cse.ohio-state.edu/~wang.77/papers/Tan-Wang1.interspeech18.pdf">[2]</a> that models the recurrency independently from the front-end feature extraction, it is advantageous. This is an inital attempt towards building higher models motivated from this startegy.
